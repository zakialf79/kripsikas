    ...
    <div class="flex items-center gap-2 overflow-hidden">
        ...
        <div class="min-w-0 flex flex-col justify-center">
            <div class="flex items-center gap-1.5">
                ...
                <span id="liveClock" class="text-[9px] bg-blue-900/60 border border-blue-400/30 text-yellow-300 px-1.5 py-0.5 rounded-md font-bold tracking-widest font-mono shadow-inner drop-shadow-sm">--:--:--</span>
            </div>
            <p class="text-[9px] sm:text-[10px] text-cyan-100 truncate mt-0.5" id="visualBulan">Periode Catatan</p>
        </div>
    </div>
