<!-- KrispiKas - Header Component -->
<header class="bg-gradient-to-r from-amber-500 to-amber-600 text-white p-4 shadow-md sticky top-0 z-40 rounded-b-3xl flex justify-between items-center">
    <div>
